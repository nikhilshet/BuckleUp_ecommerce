        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/formal1.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Black Leather</h2>
            <p>A pair of black solid round toe formal derbys with regular styling has a lace-up closure
              ...
              <p>  <strong class="text-primary h4">Rs.3,000.00</strong></p>
