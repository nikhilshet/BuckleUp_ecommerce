      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.php">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Brown Loafers</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/formal.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Brown loafers</h2>
            <p>A pair of brown round-toe formal loafers, has slip-on fastening
              Synthetic upper
              Cushioned footbed
              Textured rubber outsole, has a stacked heel
              
              Comfort fit
              
              Synthetic leather
              Wipe gently with a dry cloth to remove any dried-on dirt and dust
              </p>
            

            <p><del>Rs.4,000.00</del>  <strong class="text-primary h4">Rs.3,000.00</strong></p>
            ...
            <div class="mb-5">
              <div class="input-group mb-3" style="max-width: 220px;">
                ...
                <input id="quantity_sh" name="quantity_shoes" type="text" class=" form-control text-center" value="1" placeholder=""
            ...
            <input type="hidden" name="Item_Name" value="Brown Loafers">
            <input type="hidden" name="Price" value="3000">
            <input type="hidden" name="redirect" value="desf1.php">
          </form>
              ...
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <table class="table custom-table">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">bl0987</th>
                        <td>Comfort fit <br> Brown Leather</td>
                        <td>1 </td>
                      </tr>
