        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/conv7.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">converse run star hike </h2>
            <p> Enhanced cushioning, same versatility. The Chuck 70 High Top is built off of the original '70s design, with premium materials and extraordinary attention to detail. A cushioned insole provides arch support and stability. Inspired by the casual luxe style trend, this edition is made over in soft suede and the season's top trending colors.
              </p>
            

              <p><strong class="text-primary h4">Rs.5,000.00</strong></p>
              ...
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <table class="table custom-table">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">yfr4aada</th>
                        <td>Comfort fit <br> Beige</td>
                        <td>1 </td>
                      </tr>
