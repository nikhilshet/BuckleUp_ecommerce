        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/yeezy3.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Yeezy Boost 380 </h2>
            <p> The adidas Yeezy Boost 380 ‘Alien Blue’ delivers a wintry colorway of the lifestyle silhouette, highlighted by a grey and cream Primeknit upper with reflective detailing for enhanced visibility in low-light conditions. A subtle green finish distinguishes the monofilament window that adds textural depth to the sneaker’s lateral side panel. The sock-like build is mounted on a full-length Boost midsole, wrapped in a semi-translucent blue rubber cage and supported by a herringbone-tread rubber outsole.
              </p>
            

              <p><strong class="text-primary h4">Rs.51,000.00</strong></p>
              ...
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <table class="table custom-table">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">yadi38087</th>
                        <td>Comfort fit <br> Blue</td>
                        <td>1 </td>
                      </tr>
