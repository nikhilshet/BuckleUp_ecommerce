        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/conv2.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">converse run star hike </h2>
            <p> Blending Chuck 70s with a chunky platform and jagged
                two-tone sole, the newest icon elevates your look
              </p>
            

              <p><del>Rs 12,000.00</del><strong class="text-primary h4">Rs.9,000.00</strong></p>
              ...
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <table class="table custom-table">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">yfr442255</th>
                        <td>Comfort fit <br> Brown</td>
                        <td>1 </td>
                      </tr>
