      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.php">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Air Jordan 1 Fragments</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/aj1.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
              <h2 class="text-black">Air Jordan 1 Fragments</h2>
              <p>It's the rare sneaker that satisfies the "rule of three"—sometimes, 
              having three minds is greater than one. In the case of Jordan Brand, 
              Travis Scott and Hiroshi Fujiwara's Fragment Design, 
              it was a case of three masterminds coming together to collaborate on not just any Air Jordan, 
              but the beloved Air Jordan 1—a model both the Houston rapper and the Japanese designer have tapped for past Jordan Brand link-ups.
              </p>
            

              <p><del>Rs.1,40,000.00</del>  <strong class="text-primary h4">Rs.1,20,000.00</strong></p>

              <div class="colors">
                <div class="color">
                  <a href="images/bluejordan.webp" alt="Image" class="img-fluid p-5"></a>
                </div>
                <div class="color">
                <a href="images/blackjordan.webp" alt="Image" class="img-fluid p-5"></a>
              </div>
              <div class="color">
                <a href="images/redjordan.webp" alt="Image" class="img-fluid p-5"></a>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <button class="btn btn-primary btn-lg btn-block" onclick="window.location='degree.php'">View 3D
                  </button>
              </div>
            </div>
          <form action="managecart.php" method="POST">
            <div class="mb-5">
              <div class="input-group mb-3" style="max-width: 220px;">
                ...
                <input name="quantity_shoes" type="text" class="form-control text-center" value="1" placeholder=""
              ...
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <table class="table custom-table">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">SNEJOR001</th>
                        <td>Comfort Fit Running Shoes, Size 10, 1 Pair</td>
                        <td>1 BT</td>
                      </tr>
                ...
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                  ...
                  <table class="table custom-table">
                    ...
                    <tr>
                      ...
                      <td class="bg-light">8, 10, 12</td>
                    </tr>
                    <tr>
                      <td>COLOR OPTIONS</td>
                      <td class="bg-light">Black, Brown, White</td>
                    </tr>
                    <tr>
                      <td>SHOE TYPE</td>
                      <td class="bg-light">Sneakers</td>
                    </tr>
