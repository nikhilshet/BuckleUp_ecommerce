      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.php">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Nike Zoomx</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/sports.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Nike Zoomx</h2>
            ...
            <p><del>Rs.8,000.00</del>  <strong class="text-primary h4">Rs.9,000.00</strong></p>

            <div class="colors">
              <div class="color">
                <a href="images/bluenike.webp" alt="Image" class="img-fluid p-5"></a>
              </div>
              <div class="color">
                <a href="images/blacknike.jpeg" alt="Image" class="img-fluid p-5"></a>
              </div>
              <div class="color">
                <a href="images/rednike.webp" alt="Image" class="img-fluid p-5"></a>
              </div>
            </div>
