      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.php">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Jordan Retro 6 'British Khaki'</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/britishkhaki.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Jordan Retro 6 'British Khaki'</h2>
            ...
            <p><del>Rs.1,00,000.00</del>  <strong class="text-primary h4">Rs.69,000.00</strong></p>
            ...
            <div class="colors">
              ...
              <div class="color">
                <img src="images/airjorred.webp" alt="Image" class="img-fluid p-5">
              </div>
            </div>
