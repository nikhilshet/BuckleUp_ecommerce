      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.php">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Nike Zoom Black</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/sports1.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Nike Zoom Black</h2>
            <p>It's the rare sneaker that satisfies the "rule of three"—sometimes, 
              ...
              <strong class="text-primary h4">Rs.10,000.00</strong></p>

            <div class="colors">
              <div class="color">
                <a href="images/bluezoom.webp" alt="Image" class="img-fluid p-5"></a>
              </div>
              <div class="color">
                <a href="images/sports1.png" alt="Image" class="img-fluid p-5"></a>
              </div>
              <div class="color">
                <a href="images/redzoom.jpg" alt="Image" class="img-fluid p-5"></a>
              </div>
            </div>

            <div class="row">
              <div class="col-md-6">
                <button class="btn btn-primary btn-lg btn-block" onclick="window.location='degreesp.php'">View 3D
                  </button>
              </div>
            </div>
            ...
            <input type="hidden" name="Item_Name" value="Nike Zoom Black">
