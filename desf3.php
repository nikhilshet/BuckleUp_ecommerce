        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/formal2.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Van Huesen</h2>
            <p>A pair of black solid round toe formal derbys with regular styling has a lace-up closure
                Leather upper
                Cushioned footbed
              ...
              <p>  <strong class="text-primary h4">Rs.9,000.00</strong></p>
              ...
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <table class="table custom-table">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">VHSCFRSSL000007</th>
                        <td>Comfort fit <br> Black Leather</td>
                        <td>1 </td>
                      </tr>
