        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/yeezy5.png" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Yeezy Foamrunner </h2>
            <p> Adidas Yeezy Foam Rnnr Sand is released in a Sand-based colorway. A futuristic look is provided by its one-piece sculpted upper with oval cut-outs, which completes the design of the Adidas Yeezy Foam Rnnr Sand. Is this our entry into the world of laceless shoes?
              </p>
            

              <p><strong class="text-primary h4">Rs.29,000.00</strong></p>
